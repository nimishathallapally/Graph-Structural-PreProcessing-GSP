...
# Output dirs: output/sweep_ml25m/<mode>_frac<tag>_ms<N>/
# NOTE: identical sweep structure to run_sweep_ml1m.sh and run_sweep_yelp_compressible.sh
#       for fair cross-dataset comparison.
...
BASE_OUT="${REPO_ROOT}/output/sweep_ml25m"
